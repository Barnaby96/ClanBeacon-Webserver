...
class UserCog(commands.Cog):
    ...
    async def help(self, ctx: discord.ApplicationContext):
        commands_info = {
            ...
            "register": (
                "Link your Discord account to your Bingo player."
            ),
            "link dashboard": (
                f"Link your {BOT_NAME} dashboard account."
            ),
            "submit evidence": (
                "Submit screenshot evidence for manual Bingo review."
            ),
            "progress": (
            ...
            "review submission": (
                "Organiser only: review pending manual evidence."
            ),
            "review invalidation": (
                "Organiser only: invalidate accepted manual evidence."
            ),
            "set_team_role": (
                "Organiser only: link a Discord role to a Bingo team."
            )
        }
